...
var A = (a, t, n) => (xe(a, typeof t != "symbol" ? t + "" : t, n), n);
  ...
  (function(n, e) {
    ...
    var ee = function() {
      ...
      return o.parse = function(s) {
        ...
        if (f === V)
          return y(7);
        var k = (r = {}, r[u] = e, r[w] = c, r[i] = n, r)[f] || 1, M = this.$d.getTime() + s * k;
        return g.w(M, this);
        ...
        return S = (h = {}, h[B] = S / 12, h[l] = S, h[m] = S / 3, h[V] = (M - k) / 6048e5, h[$] = (M - k) / 864e5, h[w] = M / c, h[u] = M / e, h[i] = M / n, h)[f] || M, r ? S : g.a(S);
...
const be = /* @__PURE__ */ Q(Ue, [["render", Pe]]), qe = {
  name: "MonthCalendar",
  setup(a, { emit: t }) {
    const n = L("calendarView"), e = L("atticDatepicker"), c = L("showCalendar"), v = L("monthDays"), i = L("date");
    return {
      atticDatepicker: e,
      calendarView: n,
...
const Ye = /* @__PURE__ */ Q(qe, [["render", ct]]), ut = {
  ...
  setup(a) {
    const { calendar: t } = Ie(), n = N("dates"), e = ie(() => t.value.monthView.date(a.date)), c = N(a.date);
...
const ke = /* @__PURE__ */ Q(ut, [["render", dt]]);
class ft {
  constructor(t, n, e, c) {
    A(this, "modelValue");
    A(this, "selectedDate");
  ...
  setDisableDates(t) {
    this.disableDates = t.map((n) => typeof n == "string" ? p(n) : n.constructor.name === "Array" ? n.map((e) => typeof e == "string" ? p(e) : e) : n);
  }
  ...
  setEnableDates(t) {
    this.enableDates = t.map((n) => typeof n == "string" ? p(n) : n.constructor.name === "Array" ? n.map((e) => typeof e == "string" ? p(e) : e) : n);
  }
}
p.extend(Re);
p.extend(Le);
...
const ht = {
  ...
  setup(a, { emit: t }) {
    const n = N(!1), e = new ft(a.modelValue, a.format, a.isRange || a.isRange === "true", typeof a.keepOpen == "string" ? a.keepOpen !== "false" : a.keepOpen);
    a.disableDatesBefore && e.setDisableDatesBefore(a.disableDatesBefore), a.disableDatesAfter && e.setDisableDatesAfter(a.disableDatesAfter), a.disableDates && e.setDisableDates(a.disableDates), a.enableDatesBefore && e.setEnableDatesBefore(a.enableDatesBefore), a.enableDatesAfter && e.setEnableDatesAfter(a.enableDatesAfter), a.enableDates && e.setEnableDates(a.enableDates);
    const c = ie(() => {
...
}, Dt = { class: "md:space-y-2" }, mt = { key: 0 }, vt = { key: 1 }, yt = {
  key: 2,
  class: "text-gray-400 select-none"
}, gt = { class: "md:flex md:items-start md:space-x-3 md:space-y-0 space-y-8" };
function wt(a, t, n, e, c, v) {
  const i = ae("Calendar"), u = Se("attic");
  return se((Y(), _("div", Dt, [
    Ce(a.$slots, "default", {
      value: e.atticDatepicker.modelValue.value,
      placeholder: a.$attrs.placeholder,
      clear: e.clearDate
    }, () => [
      b("div", Ve({ class: "relative block w-full pl-3 pr-12 py-3 rounded-lg overflow-hidden text-sm transition-colors bg-white border focus:ring focus:outline-none shadow" }, a.$attrs), [
        !n.isRange && e.atticDatepicker.selectedDate.value ? (Y(), _("span", mt, O(e.atticDatepicker.modelValue.value), 1)) : n.isRange && e.atticDatepicker.modelValue.value && e.atticDatepicker.modelValue.value.length > 1 ? (Y(), _("span", vt, O(e.atticDatepicker.modelValue.value[0]) + " ~ " + O(e.atticDatepicker.modelValue.value[1]), 1)) : (Y(), _("span", yt, O(a.$attrs.placeholder ?? "Select Date"), 1))
      ], 16)
    ]),
    re(Ae, {
      ...
      default: Be(() => [
        e.showCalendar ? (Y(), _("div", {
          ...
          b("div", gt, [
            (Y(!0), _(P, null, q(parseInt(n.showXMonths ?? 1), (w) => (Y(), Oe(i, {
...
const _e = /* @__PURE__ */ Q(ht, [["render", wt]]), pt = {
  install: (a) => {
    a.component("AtticDatepicker", _e);
  }
}, Yt = Object.assign(_e, pt, {
  Calendar: ke
});
export {
  Yt as default
